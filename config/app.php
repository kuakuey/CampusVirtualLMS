...
if (!is_file($rutaConfig)) {
    ...
    die('<h1>Falta la configuración</h1><p>Copia <code>config/config.example.php</code> a <code>config/config.php</code> y completa las credenciales de la base de datos.</p>');
}
...
define('URL_CURSO_ASISTENCIA', URL_APP . '/curso.php');
define('URL_ASISTENCIA', URL_APP . '/asistencia.php');
